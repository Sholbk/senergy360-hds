  ...
  return (
    <Document>
      ...
      <Page size="LETTER" style={styles.coverPage}>
        ...
        <Text style={{ ...styles.textSmall, position: 'absolute', bottom: 40, textAlign: 'center' }}>SENERGY360 — Healthy Home Advocates</Text>
      </Page>
      ...
      <Page size="LETTER" style={styles.page}>
        ...
        <Text style={{ ...styles.textSmall, textAlign: 'center', marginTop: 8 }}>
          This report was generated by SENERGY360 Healthy Design Specifications platform.
        </Text>
        <Text style={{ ...styles.textSmall, textAlign: 'center' }}>
          For questions, contact SENERGY360 at info@senergy360.com
        </Text>
        <PageFooter />
      </Page>
    </Document>
...
function PageFooter() {
  return (
    <View style={styles.footer} fixed>
      <Text style={styles.footerText}>SENERGY360 — Healthy Design Specifications</Text>
